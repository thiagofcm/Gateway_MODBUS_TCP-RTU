...
static int initrff(void){
     usRegHoldingBuf[0] = 11;
     usRegHoldingBuf[1] = 22;
     usRegHoldingBuf[2] = 33;
     usRegHoldingBuf[3] = 44;
     return 0;
}
        ...
        do
        {
            ...
            case  's' :
                ...
                case RUNNING:
                    ...
                    if (stPortMod == 1) 
                       printf(  "Protocol stack is running. PortModbus=USB\r\n");
                    else if (stPortMod == 2) 
                       printf(  "Protocol stack is running. PortModbus=ETH0 \r\n");
                    else 
